...
const features = [
  ...
  { icon: Zap, color: "var(--color-signal-green)", title: "Autopilot Lead Follow-Up", body: "Hot leads get a message in 5 minutes. Warm leads in 1 hour. Cold leads in 3 hours. If there's no response, follow-ups continue on a smart schedule — with quiet hours, daily limits, and a confidence threshold you control.", tag: "Autopilot" },
