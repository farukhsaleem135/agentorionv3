    ...
    <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-10">
        ...
        <motion.div
          {...fadeUp}
          transition={{ delay: 0 }}
          className="bg-white border border-[#E5E7EB] rounded-2xl p-7 flex flex-col"
          style={{ minHeight: 340 }}
        >
          ...
          <h3 className="font-satoshi font-bold text-lg text-text-primary mb-2">Follow Up Boss</h3>
          <p className="text-text-secondary text-sm font-inter leading-relaxed flex-1">
          ...
          <div className="mt-4">
            <span className="inline-flex px-3 py-1 rounded-full text-[11px] font-semibold" style={{ backgroundColor: "#EEF2FF", color: "#64748B" }}>
              Coming Q4 2026
            </span>
          </div>
        </motion.div>
        ...
        >
          ...
          <h3 className="font-satoshi font-bold text-lg text-text-primary mb-2">Connect Any CRM</h3>
          <p className="text-text-secondary text-sm font-inter leading-relaxed flex-1">
        ...
        >
          ...
          <h3 className="font-satoshi font-bold text-lg text-text-primary mb-2">More Integrations Coming</h3>
          <p className="text-text-secondary text-sm font-inter leading-relaxed flex-1">
      ...
      {/* Trust line */}
      <motion.p {...fadeUp} className="text-center text-sm font-inter" style={{ color: "#9CA3AF" }}>
