        ...
        toolSchema = {
          ...
          parameters: {
            ...
            properties: {
              ...
              confidence_score: { type: "number", description: "Your confidence 0-100 that this message will get a positive response from this specific lead, based on lead data quality, conversation history, and message relevance" },
            ...
            required: ["body", "tone", "confidence_score", "follow_up_delay_hours", "best_time_to_send"],
