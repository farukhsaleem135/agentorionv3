...
BEGIN
  ...
  INSERT INTO public.funnels (id, user_id, name, slug, type, status, headline, subheadline, cta, target_area, focus, tone, views, leads_count)
  VALUES (v_funnel_id, NEW.id, 'Sample Buyer Funnel', 'sample-' || substr(replace(NEW.id::text, '-', ''), 1, 8), 'buyer', 'live',
    'Find Your Dream Home', 'Browse exclusive listings in your area', 'Get Started', 'Downtown', 'Buyers', 'Friendly', 42, 2);
